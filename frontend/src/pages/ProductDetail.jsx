...
export default function ProductDetail() {
  ...
  const [favoritesNotification, setFavoritesNotification] = useState({
    show: false,
    message: "",
    isAdd: true,
  });
    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://mern-watch-store.onrender.com/watches/${id}`
        );
  ...
  const averageRating =
    reviewData.reduce((sum, review) => sum + review.stars * review.count, 0) /
    totalReviews;
  ...
  return (
    <section className="relative pt-24 pb-12 min-h-screen text-white">
      ...
      {favoritesNotification.show && (
        <div
          className="fixed top-4 right-4 z-50 animate-slideIn md:top-6 md:right-6"
          style={{ marginTop: cartNotification.show ? "5.5rem" : "0" }}
        >
          <div
          ...
          >
            ...
            <div className="relative p-4 flex items-center">
              <div className="flex-shrink-0 p-2 rounded-lg bg-black bg-opacity-20 mr-3">
                <svg
                  className={`w-6 h-6 ${
                    favoritesNotification.isAdd ? "text-white" : "text-gray-300"
                  }`}
      ...
      {authNotification.show && (
        <div
          ...
          style={{
            marginTop:
              (cartNotification.show ? "5.5rem" : "0") +
              (favoritesNotification.show ? "5.5rem" : "0"),
          }}
        >
        ...
        <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="relative bg-gray-900 rounded-3xl shadow-2xl border border-gray-700 flex items-center justify-center p-6 min-h-[500px]">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/300x200?text=Watch+Image";
                  }}
                />
              </div>
            </div>
          ...
          <div className="lg:w-1/2 flex flex-col gap-6">
            ...
            <div className="mt-2">
              ...
              <p
                className={
                  product.inStock ? "text-green-500 mt-1" : "text-red-500 mt-1"
                }
              >
            ...
            <div className="mt-6 bg-gray-900 rounded-xl p-6 border border-gray-800">
              ...
              {!user && (
                <div className="mt-4 text-center text-sm text-gray-400">
                  ...
                  to add items to cart or favorites
                </div>
              )}
